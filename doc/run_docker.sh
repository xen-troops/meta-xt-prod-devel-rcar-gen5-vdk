...
# If you need to store/use yocto's cache outside of the container
# add the following line after the `-v "${WORKSPACE}":....`:
# -v "<your local path>/common_data/":/home/builder/common_data \
docker run \
	--network=host \
